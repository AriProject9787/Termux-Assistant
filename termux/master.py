...
def flowTransfer(os_type):
    if os_type == "Linux":
        ...
        subprocess.call("termux-tts-speak '{}'".format(aredir), shell=True)
...
#                 android(redir)
#             case 1:
#                 speak = "Updating termux and installing sl package"
#                 printf(bcolors.GREEN, speak)
#                 result = subprocess.run("pkg update && pkg install sl -y", shell=True, stdout=open("output.log", "w"), stderr=open("error.log", "w"))
#                 if result.returncode != 0:
#                     print("An error occurred. Check error.log for details.")
#                 else:
#                     printf(bcolors.GREEN, "Installation is complete")
#             case 2:
#                 speak = "Updating termux and installing cowsay package"
#                 printf(bcolors.GREEN, speak)
#                 result = subprocess.run("pkg update && pkg install cowsay -y", shell=True, stdout=open("output.log", "w"), stderr=open("error.log", "w"))
#                 if result.returncode != 0:
#                     print("An error occurred. Check error.log for details.")
#                 else:
#                     printf(bcolors.GREEN, "Installation is complete")
...
#         case 1:
#             print("Executing")
#             tool = "Starting termux tools install program"
#             toolInstall(tool)
#         case 2:
